...
const testIncreaseTime = () => {
  let stateBefore = {activity: 'work', timeLeft: 10, isOn: false, defaultTime: { workTime: 10, breakTime: 5}};
  let stateAfter = {activity: 'work', timeLeft: 10, isOn: false, defaultTime: { workTime: 11, breakTime: 5}};
...
const testDecreaseTime = () => {
  let stateBefore = {activity: 'work', timeLeft: 10, isOn: false, defaultTime: { workTime: 10, breakTime: 5}};
  let stateAfter = {activity: 'work', timeLeft: 10, isOn: false, defaultTime: { workTime: 9, breakTime: 5}};
